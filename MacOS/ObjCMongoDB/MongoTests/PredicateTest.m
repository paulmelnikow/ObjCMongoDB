...
- (void) testGreaterThanOrEqualTo {
    ...
    MongoPredicate *pred3 = [MongoPredicate predicate];
...
- (void) testMatches {
    ...
    pred1 = [MongoPredicate predicate];
    [pred1 keyPath:key matches:@"c"];
    STAssertTrue([self collection:coll boolForPredicate:pred1], @"");
    
    pred2 = [MongoPredicate predicate];
...
- (void) testMatchesAny {
    ...
    MongoPredicate *pred4 = [MongoPredicate predicate];
...
- (void) testArraySize {
    ...
    pred3 = [MongoPredicate predicate];
